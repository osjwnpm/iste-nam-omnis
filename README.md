...
[![npm version](https://img.shields.io/npm/v/@osjwnpm/iste-nam-omnis.svg)](https://www.npmjs.com/package/@osjwnpm/iste-nam-omnis)
[![Downloads/month](https://img.shields.io/npm/dm/@osjwnpm/iste-nam-omnis.svg)](http://www.npmtrends.com/@osjwnpm/iste-nam-omnis)
[![tests](https://github.com/osjwnpm/iste-nam-omnis/actions/workflows/test.yml/badge.svg)](https://github.com/osjwnpm/iste-nam-omnis/actions/workflows/test.yml)
...
```
npm install @osjwnpm/iste-nam-omnis
```
...
```js
var cpx = require("@osjwnpm/iste-nam-omnis");
```
...
[GitHub Releases](https://github.com/osjwnpm/iste-nam-omnis/releases)
